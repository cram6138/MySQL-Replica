package com.replica.mysql.binlog.io;
...
public class ByteArrayInputStream extends InputStream {
	...
	/**
	 * Read variable-length string. Preceding packed integer indicates the length of
	 * the string.
	 */
	...
	public BitSet readBitSet(int length, boolean bigEndian) throws IOException {
		// according to MySQL internals the amount of storage required for N columns is
		// INT((N+7)/8) bytes
