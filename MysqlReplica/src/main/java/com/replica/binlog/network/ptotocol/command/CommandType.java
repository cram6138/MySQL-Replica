...
public enum CommandType {
	...
	CHANGE_USER,
	/**
	 * Requests a binary log network stream from the master starting a given
	 * position.
	 */
	BINLOG_DUMP,
	/**
	...
	CONNECT_OUT,
	/**
	 * Registers a slave at the master. Should be sent before requesting a binary
	 * log events with {@link #BINLOG_DUMP}.
	 */
	REGISTER_SLAVE,
	/**
	 ...
	 * {@link #STMT_SEND_LONG_DATA} commands.
	 */
	STMT_RESET,
	/**
